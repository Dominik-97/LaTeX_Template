...
\hline
 ...
 \textit{protect others} 10 & 1,420,000,000 results \\
\hline
\hline    
\end{tabular}
\end{center}
...
Je proto logické, že si mnoho lidí pokládá otázku \textit{"Jak tedy vlastně proti dezinformacím máme bojovat?"}. Je nutné vzít v potaz několik zásaních otázek:\\

\begin{enumerate}
\item Jak bychom měli reagovat na šíření toho, co se během pandemie jeví jako nepravdivé nebo zavádějící informace, když o viru zůstává mnoho nejistoty? Pokud chybí vědecká shoda, čí rady bychom měli povýšit?
\item Jak můžeme čelit dezinformacím, když jsou předkládány jako otázky, neoficiální důkazy nebo ve vizuální podobě? Měly by se s těmito komunikačními technikami zacházet stejně jako s otevřenými tvrzeními a hodnotit se na základě jejich vnímaného záměru nebo potenciálních důsledků?
\item S ohledem na tyto úvahy, jaké jsou nejúčinnější strategie pro umírnění dezinformací a dezinformací online? např. odstranění, snížení úrovně, štítky, nahlášení. Tato otázka je komplikována sklonem k tomu, aby byly označovány a vyhledávány dotazy komunity, a obtížností implementace těchto strategií v reálném čase a v měřítku.
\end{enumerate}
\vspace*{5mm}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=14cm]{intolerance_vs_tolerance.jpeg}
  \caption{Obrázek}
  \label{fig:google trends}
\end{figure}
